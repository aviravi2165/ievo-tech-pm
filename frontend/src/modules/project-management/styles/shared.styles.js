...
const STATUS_BG = {
  ...
  hold:         th => th.colors.warning,   // new project vocabulary (was 'on-hold')
  completed:    th => th.colors.navy,
  cancelled:    th => th.colors.danger,
  closed:       th => th.colors.ash,       // new project vocabulary (was 'cancelled') — a calm "no longer active" grey, distinct from Completed's navy
