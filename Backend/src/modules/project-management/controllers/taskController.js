...
module.exports = { list, create, update, updateStatus, remove, sendRequest, removeRequest, acceptRequest, declineRequest, getMyRequests, getMyActiveTasks, getMyRecentAudit, getChat, addDep, removeDep };